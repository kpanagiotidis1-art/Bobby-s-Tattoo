...
// Per the client (2026-07-13): kept as close to his original privacy policy
// (bobisontattoo.com/pp, Enzuzo-generated) as possible — only the business
// name/entity, domain, and contact email are swapped for the studio. The
// multi-jurisdiction regulatory list and full rights section are intentionally
// left in, matching his original, at his explicit request.
//
// One addition kept from the previous draft: a line under "Personal Data We
// Collect" disclosing the consent form's government-ID upload, since his
// original never mentioned it at all and the omission would make this
// inaccurate for what this site actually collects. Still adapted boilerplate,
// not legal advice — recommend real legal review before the consent form is
// reachable via the actual QR code.
const SECTIONS = [
  {
...
This privacy policy was generated by our data privacy and compliance vendor, Enzuzo, using information and details specific to our business.`,
  },
  {
    ...
    body: `What Personal Data We Collect
...
Where you submit a tattoo inquiry or complete our in-studio consent form (accessed via QR code), we also collect your full name, date of birth, contact details, tattoo details, health declarations, a photo of your government-issued ID for age verification, and your signature.
...
We do not use cookies.`,
  },
  {
    ...
    body: `We will only retain your Personal Data for as long as necessary for the purpose for which that data was collected and to the extent required by applicable law. When we no longer need Personal Data, we will remove it from our systems and/or take steps to anonymize it.`,
  },
  {
    heading: '5. Merger or Acquisition',
    body: `If we are involved in a merger, acquisition or asset sale, your personal information may be transferred. We will provide notice before your personal information is transferred and becomes subject to a different Privacy Policy. Under certain circumstances, we may be required to disclose your personal information if required to do so by law or in response to valid requests by public authorities (e.g. a court or a government agency).`,
  },
  {
    heading: '6. How We Keep Your Data Safe',
    body: `We have appropriate organizational safeguards and security measures in place to protect your Personal Data from being accidentally lost, used or accessed in an unauthorized way, altered or disclosed.
...
In the unfortunate event of a Personal Data breach, we will notify you and any applicable regulator when we are legally required to do so.`,
  },
  {
    ...
    body: `We do not knowingly collect Personal Data from children under the age of 16 Years`,
  },
  {
    heading: '8. Your Rights for Your Personal Data',
    body: `Depending on your geographical location and citizenship, your rights are subject to local data privacy regulations. These rights may include:
...
For your own privacy and security, at our discretion, we may require you to prove your identity before providing the requested information.`,
  ...
  {
    heading: '9. Changes',
    body: `We may modify this Policy at any time. If we make changes to this Policy then we will post an updated version of this Policy at this website. When using our services, you will be asked to review and accept our Privacy Policy. In this manner, we may record your acceptance and notify you of any future changes to this Policy.`,
  },
  {
    heading: '10. Contact Us',
    body: `To request a copy for your information, unsubscribe from our email list, request for your data to be deleted, or ask a question about your data privacy, we've made the process simple: contact us at ${CONTACT_EMAIL}.`,
  },
]
